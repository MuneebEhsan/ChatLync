              ...
              <div className="bg-white rounded-3xl p-8 md:p-12 border border-slate-100 shadow-sm space-y-12 text-slate-600 leading-relaxed text-sm md:text-[15px]">
                ...
                <section id="billing" className="scroll-mt-28 space-y-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li><strong>Payment & Processing:</strong> Paid plans are processed securely via SafePay for PCI-DSS compliant payment handling. It is the user's responsibility to maintain active payment accounts for standard recurring schedules.</li>
